...
namespace LPO.Module {
    ...
    public sealed partial class LPOModule : ModuleBase {
        public LPOModule() {
            InitializeComponent();
        ...
        public override IEnumerable<ModuleUpdater> GetModuleUpdaters(IObjectSpace objectSpace, Version versionFromDB) {
            ...
            predefinedReportsUpdater.AddPredefinedReport<ProjectCommunicationReport>("Communication Report", typeof(CommunicationItem));
